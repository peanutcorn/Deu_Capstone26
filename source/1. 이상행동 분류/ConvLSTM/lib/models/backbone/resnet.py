...
# Modifier : MSP (alstjd135@gmail.com)
# ------------------------------------------------------------------------------
...
class ResNet(nn.Module):
    ...
    def _load_pretrained_model(self):
        print("==> load pretrained : {}".format(self.name))
...
#    def __init__(self, block, layers, output_stride, BatchNorm, pretrained=True, name='resnet101'):
def build_resnet(BatchNorm, name='resnet101', pretrained=True):
    if name == 'resnet18':
        model = ResNet(BasicBlock, [2, 2, 2, 2], output_stride=8, BatchNorm=BatchNorm, pretrained=pretrained, name=name)
    elif name == 'resnet34':
        model = ResNet(BasicBlock, [3, 4, 6, 3], output_stride=8, BatchNorm=BatchNorm, pretrained=pretrained, name=name)
    elif name == 'resnet50':
        model = ResNet(Bottleneck, [3, 4, 6, 3], output_stride=16, BatchNorm=BatchNorm, pretrained=pretrained, name=name)
    elif name == 'resnet101':
        model = ResNet(Bottleneck, [3, 4, 23, 3], output_stride=16, BatchNorm=BatchNorm, pretrained=pretrained, name=name)
    elif name == 'resnet152':
        model = ResNet(Bottleneck, [3, 8, 36, 3], output_stride=16, BatchNorm=BatchNorm, pretrained=pretrained, name=name)
    else:
...
if __name__ == "__main__":
    import torch
    model = build_resnet(BatchNorm=nn.BatchNorm2d, name='resnet152', pretrained=True)
