...
class NIADataset_markany(JointsDataset):
    ...
    def _get_db(self):        
        ...
        for a in anno:
            image_name = a['image']
            image_name = image_name.reaplce('\\', os.sep)
    ...
    def evaluate(self, cfg, preds, output_dir, *args, **kwargs):
        ...
        print("jnt_missing = {}".format(jnt_missing.shape))
        print("pos_gt_src = {}".format(pos_gt_src.shape))
        pos_pred_src = np.transpose(preds, [1, 2, 0])
        print("pos_pred_src = {}".format(pos_pred_src.shape))
        '''
